        ...
        child: Column(
          ...
          children: [
            ...
            _buildScoreBar(
              context,
              AppStrings.nlpScore,
              'MobileBERT AI analysis (40% weight)',
              nlpScore,
              AppColors.primary,
            ),
            ...
            _buildScoreBar(
              ...
              'URL & domain intelligence (30% weight)',
              domainScore / 100,
              AppColors.warning,
            ),
            const SizedBox(height: 12),
            _buildScoreBar(
              context,
              AppStrings.ruleScore,
              'Keyword rule matching (20% weight)',
              riskScore > 0 ? ((riskScore - nlpScore * 0.4 - domainScore / 100 * 0.3).clamp(0.0, 0.3) / 0.3) : 0.0,
              AppColors.suspicious,
            ),
            const SizedBox(height: 12),
            _buildScoreBar(
              context,
              'Final ${AppStrings.riskScore}',
